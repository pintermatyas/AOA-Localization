...
def test_real_life_scenario():
    first = "\r\n+UUDF:6C1DEBA4241B,-65,26,-65,6,37,\"CCF9579B2279\",\"\",1129320\r\n"
    second = "\r\n+UUDF:6C1DEBA4241B,-59,32,-67,0,39,\"CCF9579B217F\",\"\",1117130\r\n"
    third = "\r\n+UUDF:6C1DEBA4241B,-62,38,-58,8,39,\"CCF9579B223C\",\"\",1111242\r\n"
    fourth = "\r\n+UUDF:6C1DEBA4241C,-65,26,-65,6,37,\"CCF9579B2279\",\"\",1129320\r\n"
    fifth = "\r\n+UUDF:6C1DEBA4241C,-59,32,-67,0,39,\"CCF9579B217F\",\"\",1117130\r\n"
    sixth = "\r\n+UUDF:6C1DEBA4241C,-62,38,-58,8,39,\"CCF9579B223C\",\"\",1111242\r\n"
    ...
    while True:
        ...
        #udp_socket.sendto(first.encode('utf-8'), server_address)
        send_spoofed_packet("1.2.3.4", constants.GATEWAY_IP, 12345, constants.INGRESS_SERVER_PORT, fourth)
        #udp_socket.sendto(second.encode('utf-8'), server_address)
        send_spoofed_packet("1.2.3.5", constants.GATEWAY_IP, 12345, constants.INGRESS_SERVER_PORT, fifth)
        #udp_socket.sendto(third.encode('utf-8'), server_address)
        send_spoofed_packet("1.2.3.6", constants.GATEWAY_IP, 12345, constants.INGRESS_SERVER_PORT, sixth)
